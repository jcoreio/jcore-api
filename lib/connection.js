...
Connection.prototype.getRealTimeData = function(request, callback) {
  ...
  if(callback === undefined) {
    ApiCommon.ensureFiber("getRealTimeData");
...
Connection.prototype.getMetadata = function(request, callback) {
  ...
  if(callback === undefined) {
    ApiCommon.ensureFiber("getMetadata");
    return wait.forMethod(this, '_getMetadata', request);
  } else {
    this._getMetadata(request, callback);
  }
};

Connection.prototype._getMetadata = function(request, callback) {
